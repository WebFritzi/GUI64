...
+               lda #0
                ...
                jmp finish
!ifdef WIN{
flb_scroll_pgdn ldx ControlTopIndex
                dex
                dex
                txa
                clc
...
flb_scroll_pgdn ldx ControlNumStr
                ...
                sec
                sbc ControlHeight
                sta dummy; highest possible top index
                inc dummy
                ldx ControlTopIndex
                dex
                dex
...
ScrollDownText  lda ControlIndex+CTRLSTRUCT_TOPLO
                sta $fb
...
; No last Return: A=0 and result = TotalStart
...
ScrollUpText    lda TotalStart
                cmp ControlIndex+CTRLSTRUCT_TOPLO
                lda TotalStart+1
                sbc ControlIndex+CTRLSTRUCT_TOPHI
                bcc +
                rts
...
ScrollPgDownHex ldy HeightMinus2
                dey
-               jsr ScrollDownHex
                dey
                bpl -
...
ScrollPgUpHex   ldy HeightMinus2
                dey
-               jsr ScrollUpHex
                dey
                bpl -
...
ScrollUpHex     lda ControlIndex+CTRLSTRUCT_TOPLO
                sec
                sbc BytesPerLine
                sta dummy
                lda ControlIndex+CTRLSTRUCT_TOPHI
