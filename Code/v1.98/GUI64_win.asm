...
!zone MainBody
                ...
                !source "DriveWindow_win.asm"
                !source "SD2IEC_win.asm"
                !source "SettingsWindow_win.asm"
                !source "ViewerWindow_win.asm"
                !source "ShowDialogs_win.asm"
...
; ATTENTION: PATH_A_EX is at $7000

!zone Appendix
; The following is copied to $d000 at GUI64 startup
;*=GRAPHICSDATA
GraphicsData    !bin "chars40_win.bin"
