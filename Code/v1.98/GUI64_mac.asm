...
!zone MainLoop
;dumm            !byte 0; Comment out if indirect jumps occur
...
!zone MainBody
                ...
                !source "DriveWindow_mac.asm"
                !source "SD2IEC_mac.asm"
                !source "SettingsWindow_mac.asm"
                !source "ViewerWindow_mac.asm"
                !source "ShowDialogs_mac.asm"
...
; ATTENTION: PATH_A_EX is at $6500

!zone Appendix
; The following is copied to $d000 at GUI64 startup
;*=GRAPHICSDATA
GraphicsData    !bin "chars3_mac.bin"
