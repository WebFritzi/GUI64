...
MENUBAR_BUF         = $a000
DESKTOP_BUF         = $a028
MENUBAR_CLR_BUF     = $a400
DESKTOP_CLR_BUF     = $a428
...
FILEVIEWERBUF_BLOCKS= (FILEVIEWERBUF_END - FILEVIEWERBUF_START)/256
;=============================================================
;
