...
DblClickAction  lda #0
                sta is_dnp
                jsr GetFile
                sty HasFileExt+1; string len, self-modifying code below
                sty IsPRGExt+1; self-modifying code below
                sty IsValidFileExt+1; self-modifying code below
                sty IsTxtExt+1; self-modifying code below
                jsr GetCurDeviceNo
                lda Str_FileType
                cmp #"S"; SEQ
                beq GoViewFile
...
IsTxtExt        ldy #$FF; Is filled in DblClickAction and is the fn string length
                dey
                lda Str_FileName,y
                cmp #$54; 't'
                beq +
...
++              ; Do paste
                ...
                ; Error
                jsr ShowDiskError
                +AddBitToCurWnd BIT_WND_ISERRMSG
                jsr bttr
                jmp InstallIRQ
+               lda IsCut
                beq ++
