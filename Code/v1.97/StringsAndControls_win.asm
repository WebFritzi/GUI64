...
Wnd_Ultimate    !byte WT_ULTIMATE, %00110011, 9, 4, 20, 7, <Str_Title_Ult, >Str_Title_Ult, <UltWndProc, >UltWndProc
...
Menu_Start      !pet ID_MENU_START,8,5,"Settings",0," ",0,"About",0," ",0,"BASIC",0
