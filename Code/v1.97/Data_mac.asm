...
Clock           !byte 0,0,0,0
MayShowClock    !byte 1
MouseInfo       !byte 0,0,0,0,0,0;MouseInfo: xScr,yScr,x,y,xHiByte,yScr-1
...
CanCopy         !byte 0
IsCut           !byte 0
DiskToCopyFrom  !byte 0,0 ;DevNo, DevInd
...
DragNewPosX     !byte 0
DragNewPosY     !byte 0
DragNewHeight   !byte 0
DragObjectWidth !byte 0
DragObjectHeight!byte 0
DragObjectType  !byte 0; DOT_WINDOW: 0, DOT_ICON: 1
;---- Icons -------------------
...
IsDiskImage     !byte 0,0; 0 for not; 1: d64, 2: d71, 3: d81, 4: dnp
