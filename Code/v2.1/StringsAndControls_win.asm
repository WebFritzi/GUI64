...
Wnd_Ultimate    !byte WT_ULTIMATE, %00110110, 8, 1, 25, 20, <Str_Title_Ult, >Str_Title_Ult, <UltWndProc, >UltWndProc
...
;------------------------------
; Disk Info Dialog
Wnd_Dlg_DiskInfo!byte WT_DLG_DISKINFO, %00001100, 10, 3, 20, 15, <Str_Dlg_DiskInfo, >Str_Dlg_DiskInfo, <MessageDlgProc, >MessageDlgProc
                ;0
...
;------------------------------
; Format disk Dialog
Wnd_Dlg_Format  !byte WT_DLG_FORMAT, %00001100, 10, 4, 21, 13, <Str_Dlg_For_Disk, >Str_Dlg_For_Disk, <FormatDlgProc, >FormatDlgProc
                ;0
...
Menu_Start      !pet ID_MENU_START,8,7
Str_Title_Settings
                !pet "Settings",0," ",0,"About",0," ",0
Str_Dlg_BASIC   !pet "BASIC",0
                !pet " ",0,"Reboot",0
...
Menu_Ult_Disk   !pet ID_MENU_IMAGE,10,3,"Mount to A",0,"Mount to B",0,"Close",0
; Viewer Window
