...
; (comes also in FB)
;--------------------------------------------------------------
PaintMenuBar    jsr WndAddrInBufToFD
                jsr AddBufWidthToFD
                ;
                jsr SetColBufPos
                ;
...
Top             !byte 30,39,31; EditSL
                !byte 16,17,18; Button up
                !byte 23,39,39; Button down
Middle          !byte 41,4,37; EditSL
                !byte 37,4,19; Button up
                !byte 27,4,41; Button down
Bottom          !byte 32,36,33; EditSL
                !byte 22,21,20; Button up
                !byte 26,4,24; Button down

middle_ind      !byte 0
; Call with X = middle_ind
; X=1: EditSL
; X=4: Button up
; X=7: Button down
PaintControlFrame
...
-               lda #25
                ...
                ldy ControlWidth
                dey
                dey                         ; Y = Anzahl innerer Zeichen
                sty ZP_5F
-               tya
                clc
                adc #(DT_Reserved_Char-1)
                sta ($06),y                 ; mittlere Zeile
                clc
                adc ZP_5F
                sta ($08),y                 ; untere Zeile
                dey
                bne -
                rts
                ;ldy ControlWidth
