...
BoxWidth            = $08
BoxHeight           = $09
file_size_dec       = $0a; 3 bytes (0a - 0c) (6 digit decimal number (actually 5 digits only))
; Complete window structure for current window----------------
CurrentWindow       = $10; Index/handle of current window (0-15)
WindowType          = $11
WindowHeightEx      = $12; see below for documentation
...
MouseInfo           = $30;6 bytes: xScr,yScr,x,y,xHiByte,yScr-1
error_code          = $36
...
AllocedWindows      = $41
WndAddressInBuf     = $42; 2 bytes
ViewerEOF           = $44; 2 bytes
PathLength          = $46; 2 bytes (46/47)
active              = $48; Only MAC
WindowOnHeap        = $49; 2 bytes
ControlOnHeap       = $4b; 2 bytes
ClipEnd             = $4d; 2 bytes (4d/4e)
TotalStart          = $4f; 2 bytes
MousePosInWndX      = $51
MousePosInWndY      = $52
actkey              = $53
BufWidth            = $54
...
CurMenuHeight       = $8c
U_CurTarget         = $8d
CurrentMenu         = $8e; 2 bytes (ptr to cur menu)
...
MENUBAR_BUF         = $8000
DESKTOP_BUF         = $8028
MENUBAR_CLR_BUF     = $8400
DESKTOP_CLR_BUF     = $8428
...
BIT_WND_IS_ICONIZED = %01000000
; Specific last bit, overridden
; by the following ones
BIT_WND_SPECIFIC = %10000000
BIT_WND_ISDISK   = %10000000
BIT_WND_ISERRMSG = %10000000
;----------------------------------
; Window Messages (should exceed exit codes)
WM_PRESSMENUBAR = 50
;----------------------------------
