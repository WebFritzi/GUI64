...
## Ultimate Users
Ultimate users (1541 Ultimate II(+L), Ultimate 64(EI/II), and C64 Ultimate) benefit from automatic saving of their settings (colors, desktop pattern, icon positions, device numbers) in the Ultimate's Flash folder, along with an accurate time display. Moreover, they can mount images on SD-card or USB deviced attached to the Ultimate.
