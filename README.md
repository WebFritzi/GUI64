...
## Ultimate Users
Ultimate users [1541 Ultimate II(+L), Ultimate 64(EI/II), and C64 Ultimate] can mount images on SD-card or USB devices attached to their Ultimates. Moreover, they benefit from automatic saving of their settings (colors, desktop pattern, icon positions, device numbers) in the Ultimate's Flash folder, along with an accurate time display.
